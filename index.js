...
document.addEventListener('DOMContentLoaded', function () {
    const productContainer = document.getElementById('ngoi');
    ...
    fetch('/Product-Page/products.json')
        ...
        .then(products => {
            ...
            filteredProducts = allProducts.filter(product => product.category === "Ngói");
...
// Gạch Lát
document.addEventListener('DOMContentLoaded', function () {
    const productContainer = document.getElementById('gach-lat');
    const productsPerPage = 12;
    let currentPage = 1;
    let allProducts = [];
    let filteredProducts = [];
    ...
    fetch('/Product-Page/products.json')
        ...
        .then(products => {
            allProducts = products; // Save all products.
            filteredProducts = allProducts.filter(product => product.category === "Gạch Lát");
